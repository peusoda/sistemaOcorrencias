                ...
                <div class="card-body">
                  ...
                  <table class="table" id="table">
                        ...
                        <fieldset>
                            ...
                            {{ Form::label('funcao', 'Função *', array('class' => 'col-md-1 control-label')) }}
                              <!--<label class="col-md-1 control-label" for="radios">Função<h11>*</h11></label>-->
                              <div class="col-md-4"> 
                                  <input name="funcao" id="funcao" value="p" type="radio" required>
                                  Professor
                                </label> &nbsp
                                <label class="radio-inline" for="radios-1">
                                  <input name="funcao" id="funcao" value="t" type="radio">
                                  Técnico
                                </label>
                              </div>
